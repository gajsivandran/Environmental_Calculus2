...
Negative, because signed area below the axis subtracts from net accumulation.
...
Total area ignores sign; net accumulation keeps sign and represents overall change.
...
Net accumulation is negative; values below the axis dominate overall.
...
Total mass (density integrated over volume).
