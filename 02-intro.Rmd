...
![](images/Accumulation.png){fig.alt='decorative' style="float=center, width:450px; margin:10px;"}
...
![](images/int_conceptual.png){fig.alt='A simple conceptual diagram showing the relationship between differentiation and integration. On the left is a function f(x) a differentiation arrow points to f'(x). Another arrow goes from right to left, from f'(x) to f(x) with the word integration' style="float=center, width:450px; margin:10px;"}
